class Auth0Controller < ApplicationController
  ...
  def logout
    ...
    redirect_to "https://memtank.eu.auth0.com/v2/logout?federated?returnTo=http://localhost:300://memtank.eu.auth0.com/v2/logout?federated?returnTo=http://localhost:3000"
  end
